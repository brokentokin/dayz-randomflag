[h1]Random Flag[/h1]
Random Flag adds a lootable "Folded Flag" item that can become one of several different flags once opened. This allows you to keep flags relatively rare in the economy while allowing for a large number of flag variants.
...
[*]Includes 34 vanilla DayZ flag classnames by default; add classnames from other mods or if vanilla changes, or remove classnames to take them out of the selection pool.
[*]"Open Flag" duration is configurable. Default is two seconds, and has a one-second minimum if configured to be less than 1.0.
[/list]
[h2]Installation[/h2]
Random Flag is a Client mod.
